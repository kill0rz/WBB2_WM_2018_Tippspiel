...
if ($action == "options") {
	...
	if ($wm2018_options['showtableonindex'] == "1") {
		$sel_showtableonindex[1] = " selected";
	} else {
		$sel_showtableonindex[0] = " selected";
	}
