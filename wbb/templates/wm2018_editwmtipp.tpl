...
<body>
					...
					<tr class="tablea_fc">
						<td align="left">
							<span class="smallfont">
								<b><a href="index.php{$SID_ARG_1ST}">$master_board_name</a> &raquo; <a href="wm2018.php?action=index{$SID_ARG_2ND}">{$lang->items['LANG_WM2018_TPL_MAKETIPP_2']}</a> &raquo; {$lang->items['LANG_WM2018_TPL_EDITWMTIPP_2']}</b>
							</span>
						</td>
						<td align="right">
							<span class="smallfont">
	...
	<br />
	<form method="post" action="wm2018.php?action=editwmtipp">
