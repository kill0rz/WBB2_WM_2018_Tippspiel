<br />
<form method="post" action="em2016.php?action=tippabgabe_vem">
		...
		<tr>
			<td class="tabletitle" colspan="3" align="center">
				<span class="smallfont">
					<b>
						<u>{$lang->items['LANG_EM2016_TPL_TIPPABGABE_VEM_1']}</u>
					</b>
					<br />{$lang->items['LANG_EM2016_TPL_TIPPABGABE_VEM_2']}</span>
			</td>
		</tr>
		<tr>
			<td class="tableb" align="center" width="70%">
				<span class="smallfont">{$lang->items['LANG_EM2016_TPL_TIPPABGABE_VEM_3']}</span>
			</td>
