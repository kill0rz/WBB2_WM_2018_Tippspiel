...
if ($action == "index") {
	...
	$result_nextgames = $db->query("SELECT * FROM bb" . $n . "_wm2018_spiele WHERE datetime < '" . intval($akttime) . "' AND game_goals_1 = '' AND game_goals_1 = '' ORDER BY datetime ASC Limit 0,{$wm2018_options['nonaddedgamescount']};");
	while ($row_nextgames = $db->fetch_array($result_nextgames)) {
